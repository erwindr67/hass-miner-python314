...
class MinerCoordinator(DataUpdateCoordinator):
    ...
    # from __future__ import annotations makes this annotation a string,
    # so pyasic does not need to be imported at class definition time.
    ...
    async def get_miner(self):
        ...
        import pyasic  # lazy import; pyasic installed by async_setup_entry
